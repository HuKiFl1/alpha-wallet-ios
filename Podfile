...
target 'AlphaWallet' do
  ...
  pod 'QRCodeReaderViewController', :git=>'https://github.com/vladyslav-iosdev/QRCodeReaderViewController.git',:branch=>'#1814', :commit=>'87df7cea042fc35b970a4187d064f24d35f0b89a'
